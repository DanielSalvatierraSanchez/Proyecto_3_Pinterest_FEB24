import './header.css';
import { imagesRandom, searchImages } from "../../src/gallery/gallery.js";
...
const createHeaderLogo = () => {
  ...
  imgHeader.src = '../../public/logo2.png';
...
const createHeaderList = () => {
  ...
  aHeaderInicio.href = imagesRandom();
  ...
  aHeaderExplorar.href = imagesRandom();
  ...
  aHeaderCrear.href = imagesRandom();
